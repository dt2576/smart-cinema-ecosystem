...
> Một Seat đã mua tương ứng với một Ticket.
...
Mỗi Ticket có token/mã duy nhất.
...
QR không tự chứng minh ticket hợp lệ.
...
Việc kiểm tra thời gian check-in sẽ được đặc tả chi tiết trong SRS.
...
Một Ticket không được check-in thành công nhiều lần.

### INV-09 — Cinema validation

Ticket chỉ được check-in tại Cinema phù hợp.
...
Business Analysis v2.0 này là baseline để xây dựng BRD và SRS ở các bước tiếp theo.